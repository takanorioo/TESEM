							...
							<?php if(!empty($pattern_element['PatternAttribute']['type'])): ?>
								<?php for($i = 0; $i < count($pattern_element['PatternAttribute']['type']); $i++): ?>
									<tr>
										...
										<td><a href="<?php echo FULL_BASE_URL; ?>/patterns/attribute_delete/<?php echo $pattern_element['PatternAttribute']['id'][$i];?>" onclick="return confirm('Are You Sure ?');" style="margin: 10px;font-size: 20px;color: red;"><img src="<?php echo FULL_BASE_URL; ?>/img/delete_icon.png" style="margin-top: 5px;"></a>
										</td>
									</tr>
								<?php endfor; ?>
							<?php endif; ?>
							...
							<?php if(!empty($pattern_element['PatternMethod']['type'])): ?>
								<?php for($i = 0; $i < count($pattern_element['PatternMethod']['type']); $i++): ?>
									<tr>
										...
										<td><a href="<?php echo FULL_BASE_URL; ?>/patterns/method_delete/<?php echo $pattern_element['PatternMethod']['id'][$i];?>" onclick="return confirm('Are You Sure ?');" style="margin: 10px;font-size: 20px;color: red;"><img src="<?php echo FULL_BASE_URL; ?>/img/delete_icon.png" style="margin-top: 5px;"></a>
										</td>
									</tr>
