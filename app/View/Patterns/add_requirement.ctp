		...
		<div class="row">
			<div class="col-md-8 well">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><?php echo $this->Form->input('PatternRequirement.condition', array('label' => false, 'div' => false, 'id' => '', 'type' => 'text', 'class' => 'form-control', 'placeholder' => 'Condition', 'error'=>false)); ?></td>
						</tr>
					</tbody>
				</table>
			</div>
