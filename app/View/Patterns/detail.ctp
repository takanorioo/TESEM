                  ...
                  <?php if(!empty($behaviors_data['PatternBehavior']['id'])): ?>
                    <?php for($i = 0; $i < count($behaviors_data['PatternBehavior']['id']); $i++): ?>
                      <tr>
                        ...
                        <td><a href="/<?php echo $base_dir;?>/pattern/behabior_element_delete/<?php echo $behaviors_data['PatternBehavior']['id'][$i];?>" onclick="return confirm('Are You Sure ?');" style="margin: 10px;font-size: 20px;color: red;"><img src="/<?php echo $base_dir;?>/img/delete_icon.png" style="margin-top: 5px;"></a>
                        </td>
                      </tr>
                    <?php endfor; ?>
                  <?php endif; ?>
