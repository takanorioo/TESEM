									...
									<?php if(!empty($behaviors_data['Behavior']['id'])): ?>
										<?php for($i = 0; $i < count($behaviors_data['Behavior']['id']); $i++): ?>
											<tr>
												...
												<td><a href="<?php echo FULL_BASE_URL; ?>/behavior/element_delete/<?php echo $behaviors_data['Behavior']['id'][$i];?>" onclick="return confirm('Are You Sure ?');" style="margin: 10px;font-size: 20px;color: red;"><img src="<?php echo FULL_BASE_URL; ?>/img/delete_icon.png" style="margin-top: 5px;"></a>
												</td>
											</tr>
										<?php endfor; ?>
									<?php endif; ?>
