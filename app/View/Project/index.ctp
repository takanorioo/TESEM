      ...
      <div class="col-md-10">
        <?php if(!empty($public_projects)): ?>
          ...
          <table class="table ">
            ...
            <tbody>
              <?php for($i = 0; $i < count($public_projects); $i++ ): ?>
                <tr>
                  <td><a href="<?php echo FULL_BASE_URL; ?>/projects/set_project/<?php echo h($public_projects[$i]['Project']['id']) ?>"><?php echo h($public_projects[$i]['Project']['name']) ?></a></td>
                  <td>
                    Public
                  </td>
                </tr>
    ...
    <?php if(!empty($projects)): ?>
      <table class="table">
        ...
        <tbody>
          <?php for($i = 0; $i < count($projects); $i++ ): ?>
            <tr>
              <td><a href="<?php echo FULL_BASE_URL; ?>/projects/set_project/<?php echo h($projects[$i]['Project']['id']) ?>"><?php echo h($projects[$i]['Project']['name']) ?></a></td>
              <td>
              ...
              <td style="width: 280px;">
                <img src="<?php echo FULL_BASE_URL; ?>/img/user/user_<?php echo $projects[$i]['Project']['user_id']; ?>.jpg" class="avatar img-thumbnail" style="width: 50px;">
                <?php for($j = 0; $j < count($projects[$i]['UsersProject']); $j++ ): ?>
                  <img src="<?php echo FULL_BASE_URL; ?>/img/user/user_<?php echo $projects[$i]['UsersProject'][$j]['user_id']; ?>.jpg" class="avatar img-thumbnail" style="width: 50px;">
                <?php endfor; ?>
                <td>
                  <a class="btn btn-primary"  href="#" data-toggle="modal" data-target="#Modal_<?php echo h($projects[$i]['Project']['id']) ?>">Invite member</a></td>
                  <td><a href="<?php echo FULL_BASE_URL; ?>/projects/delete/<?php echo h($projects[$i]['Project']['id']) ?>" class = "btn btn-danger">Delete</a></td>
                </tr>
              <?php endfor; ?>
            </tbody>
          </table>
          ...
          <table class="table ">
            ...
            <tbody>
              <?php for($i = 0; $i < count($invited_projects); $i++ ): ?>
                <tr>
                  <td><a href="<?php echo FULL_BASE_URL; ?>/projects/set_project/<?php echo h($invited_projects[$i]['Project']['id']) ?>"><?php echo h($invited_projects[$i]['Project']['name']) ?></a></td>
                  <td>
                  ...
                  <td style="width: 280px;">
                    <?php for($j = 0; $j < count($invited_projects[$i]['Project']['Member']); $j++ ): ?>
                      <img src="<?php echo FULL_BASE_URL; ?>/img/user/user_<?php echo $invited_projects[$i]['Project']['Member'][$j]; ?>.jpg" class="avatar img-thumbnail" style="width: 50px;">
                    <?php endfor; ?>
                    <td>
                    </tr>
                  <?php endfor; ?>
